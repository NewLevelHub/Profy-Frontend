...
import { CompletedTestCard } from './sections/CompletedTestCard';

const GREETING_SUBTITLE: Record<'not_started' | 'in_progress', string> = {
...
export default function HomePage() {
  ...
  const {
    ...
    completedAt, directionName, directionSlug, questionsAnswered, matchPercent, isCompletionLoading,
    confirmRestart, handleRestartRequest, handleRestartConfirm, handleRestartCancel,
  } = useHome();
