    ...
    <Card className="flex flex-col gap-6">
      <div className="flex items-start justify-between gap-5 flex-wrap">
        <div className="flex flex-col gap-2 min-w-0 flex-1">
          <span className={`${typeClass.monoLabel} text-muted`}>ДИАГНОСТИКА · В ПРОЦЕССЕ</span>
      ...
      <div>
        <Spine value={progressPct} ariaLabel="Прогресс диагностики" flat />
        <div className="flex justify-between mt-2 mx-0.5 text-mono-sm">
          <span className="font-bold text-muted">Диагностика</span>
