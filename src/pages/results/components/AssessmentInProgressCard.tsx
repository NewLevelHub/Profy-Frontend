...
interface AssessmentInProgressCardProps {
  /** How many of the 4 phases (Likert+pairs, motivation, Belbin, АСТУР) are
    ...
    >
      ...
      <div className="journey-progress">
        ...
        <div className="flex justify-between mt-2.5 mx-0.5">
          <span className="text-caption font-semibold text-muted">{t(`inProgress.phase.${currentPhase}`)}</span>
